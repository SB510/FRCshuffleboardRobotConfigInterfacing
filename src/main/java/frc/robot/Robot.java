...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    System.out.println(RobotConfig.TEST_VALUE);
    ...
    while (true){
      System.out.println("Test Value:"+RobotConfig.getInstance().TEST_VALUE);
      System.out.println("Test 2:"+RobotConfig.getInstance().Test_2);
    }
  }
